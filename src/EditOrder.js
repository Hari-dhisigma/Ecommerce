...
function Editorder() {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        "https://cofdmen5mb.execute-api.us-west-2.amazonaws.com/orderSelectById",
        dt
      )
      .then(function (res) {
      ...
      <div class="containerDisplayOrder">
        ...
        <div>
          ...
          <div class="btnSaveStat">
            <button type="button" class="btn btn-success" onClick={orderupdate}>
              save
            </button>
          </div>
        </div>
